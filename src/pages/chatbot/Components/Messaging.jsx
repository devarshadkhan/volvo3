...
<i className={"fa-solid fa-check-double"} style={{color:"#33EC23"}}></i>
                ...
                <img src="/icons-images/lineHRBG.svg"/>
                    ...
                    <li className={u?.id == m?.senderId ? "sent" : "replies"}>
                      <p style={{ whiteSpace: 'pre-line' }}>
                        ...
                        {m.senderId == u.id&& <>  {m.isRead === true ? <i className={"fa-solid fa-check-double"} style={{color:"#33EC23"}}></i>:     <i className={"fa-solid fa-check"}></i> }</>}
